<template>
  <div class="container">
    <!-- 固定导航 -->
    <van-nav-bar fixed left-arrow @click-left="$router.back()" title="小熊同学"></van-nav-bar>
    ...
    <div class="chat-list">
      <div v-for="(obj, index) in list" :key="index">
          ...
          <div class="chat-item left" v-if="obj.name !== 'me'">
            <van-image fit="cover" round :src="$store.state.robotPhoto" />
  ...
  data () {
    return {
      ...
      list: [
        ...
        { name: 'xs', msg: 'hi,你好！我是机器人小熊,你可以问我问题哦~' },
        { name: 'me', msg: '我是编程小王子' }
      ],
      socket: null // 客户端与服务器建立连接的socket对象
    }
  },
  created () {
    // io建立的是socket连接与axios没有关系
